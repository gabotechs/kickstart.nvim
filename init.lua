...
vim.keymap.set('n', '<C-j>', '<cmd>Gitsigns nav_hunk next<CR>', { noremap = true, silent = true, desc = 'Move to next hunk' })
vim.keymap.set('n', '<C-k>', '<cmd>Gitsigns nav_hunk prev<CR>', { noremap = true, silent = true, desc = 'Move to prev hunk' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>b', builtin.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        return {
          timeout_ms = 500,
          -- Disable auto formatting for all
